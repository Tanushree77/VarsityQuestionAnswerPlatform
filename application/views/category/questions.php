                    ...
                    <section class="QuestionList">
                        <header class="QuestionList-header">
                            ...
                            <p class="QuestionList-meta">
                                By <a class="QuestionList-author" href="<?php echo base_url('user/' . $q->username); ?>"><?php echo $q->name ?></a> Posted <?php echo ($q->question_date) ?>  <?php echo $this->qa_model->count_where('answer', array('question_id' => $q->id_question)) ?> Answers
                            </p>
                        </header>
