        ...
        <div class="warapper-border" data-text="Question">
            <div class="grid">
                <div class="row cells6">
                    ...
                    <div class="cell colspan5">
                        <div class="fl">
                            <h3><?php echo $ask->name ?></h3>
                            <a class="QuestionList-author" href="<?php echo base_url('user/' . $ask->username); ?>"><?php echo $ask->username ?></a>
                            <p><?php echo ($ask->question_date) ?></p>
                            <a href="<?php echo base_url('category/' . uri_encode($ask->category_name)); ?>" class="button"> <?php echo $ask->category_name ?></a>
                        </div>
                        <div class="fr vote_question">
                            <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/vq_up'); ?>" data-role="hint" data-hint-mode="2" data-hint="Vote|Select for vote UP" data-hint-position="top"><span class="mif-thumbs-up "></span></a>
                            <?php if ($count_vote > 0): ?>
                            ...
                            <?php if (!empty($ask->viewers)): ?>
                                <p style="margin-right: 10px; font-size: 17px;"><i>viewers</i>  <b><?php echo $ask->viewers ?></b></p>
                            <?php endif ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="padding10">
                ...
                <?php if (!empty($ask->question_update)): ?>
                    <small><i>Question last update on</i> <?php echo ($ask->question_update) ?></small>
                <?php endif ?>
                        ...
                        <?php if ($ask->user_id === $this->qa_libs->id_user()): ?>
                            <div class="dropdown-button place-right">
                                ...
                                <ul class="split-content d-menu place-right" data-role="dropdown">
                                    <li><a href="<?php echo base_url($this->uri->segment(1) .'/'. $ask->url_question . '/update'); ?>"> Update</a></li>
                                    <li><a href="<?php echo base_url($this->uri->segment(1) .'/'. $ask->url_question . '/delete'); ?>"> Delete</a></li>
                                </ul>
                            </div>
                        <?php endif ?>
                    </div>
                ...
                <?php if (!empty($comment_in_question)): ?>
                    <?php foreach ($comment_in_question as $ciq): ?>
                        <ul class="numeric-list list-ac">
                            <li>
                                <strong class="no-margin-top" style="font-size: .675rem;"><?php echo $ciq->name ?> (<a href="<?php echo base_url('user/' . $ciq->username); ?>"><?php echo $ciq->username ?></a>)</strong> <i style="font-size: .675rem;"><?php echo ($ciq->comment_date) ?></i>
                                <?php if ($ciq->id_user == $this->qa_libs->id_user()): ?>
                                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/dc/'. $ciq->id_comment); ?>" class="tag alert" data-role="hint" data-hint-mode="2" data-hint="|Delete" data-hint-position="top">Delete</a>
                                <?php endif ?>
                                <hr class="bg-black">
                ...
                <?php endif ?>
                <div class="fc">
                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) . '/cq/' . $ask->id_question); ?>" class="button success"> Comment this Question</a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="cell">
                        ...
                        <ul class="numeric-list large-bullet list-ac">
                            ...
                            <li>
                                <strong class="no-margin-top"><?php echo $anw->name ?> (<a href="<?php echo base_url('user/' . $anw->username); ?>"><?php echo $anw->username ?></a>)</strong> <i style="font-size: .675rem;"><?php echo ($anw->answer_date) ?></i>
                                <?php if ($anw->id_user == $this->qa_libs->id_user()): ?>
                                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/da/'. $anw->id_answer); ?>" class="tag alert" data-role="hint" data-hint-mode="2" data-hint="|Delete" data-hint-position="top"></a>
                                <?php endif ?>
                                <?php if ($ask->id_user === $this->qa_libs->id_user()): ?>
                                    <?php if ($ask->answer_id != $anw->id_answer): ?>
                                        <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/answer/'. $anw->id_answer) ?>" class="cycle-button small-button" style="margin-top: -11px; margin-left: 5px;" data-role="hint" data-hint-mode="2" data-hint="Select this as answer" data-hint-position="top"></a>
                                    <?php endif ?>
                                <?php endif ?>
                                <div class="fr vote_answer">
                                    <?php if ($ask->answer_id === $anw->id_answer): ?>
                                        <button class="cycle-button success" style="margin-top: -10px;" data-role="hint" data-hint-mode="2" data-hint="This Answer|" data-hint-position="top"></button>
                                    <?php endif ?>
                                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/va_up/'. $anw->id_answer); ?>" data-role="hint" data-hint-mode="2" data-hint="Vote|Select for vote UP" data-hint-position="top"></a>
                                    ...
                                    <?php endif ?>
                                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/va_down/'. $anw->id_answer); ?>" data-role="hint" data-hint-mode="2" data-hint="Vote|Select for vote DOWN" data-hint-position="top"></a>
                                </div>
                                <hr class="bg-orange">
                                <div>
                                ...
                                <?php if (!empty($this->qa_libs->comment_in_answer($anw->id_answer))): ?>
                                    ...
                                    <ul class="numeric-list default-bullet list-ac">
                                        <li>
                                            <strong class="no-margin-top" style="font-size: .675rem;"><?php echo $cia->name ?> (<a href="<?php echo base_url('user/' . $cia->username); ?>"><?php echo $cia->username ?></a>)</strong>  <i style="font-size: .675rem;"><?php echo ($cia->comment_date) ?></i>
                                            <?php if ($cia->id_user == $this->qa_libs->id_user()): ?>
                                                <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) .'/dc/'. $cia->id_comment); ?>" class="tag alert" data-role="hint" data-hint-mode="2" data-hint="|Delete" data-hint-position="top"></a>
                                            <?php endif ?>
                                            <hr class="bg-black">
                                            <div style="font-size: .775rem;">
                                ...
                                <?php endif ?>
                                <div class="fc">
                                    <a href="<?php echo base_url($this->uri->segment(1) .'/'. $this->uri->segment(2) . '/ca/' . $anw->id_answer); ?>" class="button success"> Comment this Answer</a>
                                </div>
                            </li>
                            <?php endforeach ?>
                        </ul>
